...
namespace TEN::Scripting
{
	...
	void EffectsSettings::Register(sol::table& parent)
	{
        ...
        // @tfield[opt=true] bool fallingObjectSplashes Enables water-entry splashes for falling objects and flying creatures, including falling corpses. Does not affect Lara.
